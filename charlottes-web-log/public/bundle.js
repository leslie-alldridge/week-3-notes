...
var message = { text: "Future home of Charlotte's web" };

ReactDOM.render(React.createElement(_App2.default, { message: message }), document.getElementById('root'));
...
var _OtherBlogs = __webpack_require__(26);

var _OtherBlogs2 = _interopRequireDefault(_OtherBlogs);

var _RecentEntries = __webpack_require__(29);

var _RecentEntries2 = _interopRequireDefault(_RecentEntries);
...
function App(props) {
  return React.createElement(
    ...
    React.createElement(
      'div',
      { 'class': 'blogcontainer' },
      React.createElement(_OtherBlogs2.default, null),
      React.createElement(_Posts2.default, null),
      React.createElement(_RecentEntries2.default, null)
    ),
...
function Footer(props) {
    return React.createElement(
        ...
        React.createElement(
            'p',
            null,
            _footer2.default.copyright,
            _footer2.default.author
        )
    );
}
        ...
        React.createElement(
            ...
            _posts2.default.map(function (post) {
                return React.createElement(
                    ...
                    ' || ',
                    post.date,
                    React.createElement(_Post2.default, { postBody: post.paragraphs })
                );
            })
        )
    );
...
var _otherBlogs = __webpack_require__(27);

var _otherBlogs2 = _interopRequireDefault(_otherBlogs);

var _OtherBlog = __webpack_require__(28);

var _OtherBlog2 = _interopRequireDefault(_OtherBlog);
...
function OtherBlogs(props) {
    return React.createElement(
        'div',
        { className: 'OtherBlogs' },
        React.createElement(
            'ul',
            null,
            _otherBlogs2.default.map(function (blog) {
                return React.createElement(
                    'div',
                    { id: 'list', key: blog.id },
                    React.createElement(_OtherBlog2.default, { blogBody: blog.blogTitle, link: blog.link })
                );
            })
        )
    );
}
exports.default = OtherBlogs;
...
function OtherBlog(props) {
    return React.createElement(
        "a",
        { className: "OtherBlog", href: props.link },
        props.blogBody
    );
}
exports.default = OtherBlog;
...
var _recentEntries = __webpack_require__(30);

var _recentEntries2 = _interopRequireDefault(_recentEntries);

var _RecentEntry = __webpack_require__(31);

var _RecentEntry2 = _interopRequireDefault(_RecentEntry);
...
function OtherBlogs(props) {
    return React.createElement(
        'div',
        { className: 'RecentEntries' },
        React.createElement(
            'ul',
            null,
            _recentEntries2.default.map(function (entry) {
                return React.createElement(
                    'div',
                    { key: entry.id },
                    React.createElement(_RecentEntry2.default, { entryName: entry.name, entryLink: entry.link })
                );
            })
        )
    );
...
module.exports = [{
  ...
  id: 2,
  name: 'Last day',
  link: 'https://charlotte.net/blog/last-day'
}, {
  id: 3,
  name: 'The hour of triumph',
  link: 'https://charlotte.net/blog/the-hour-of-triumph'
}, {
  id: 4,
  name: 'The egg sac',
  link: 'https://charlotte.net/blog/the-egg-sac'
}, {
  id: 5,
  name: 'The cool of the evening',
  link: 'https://charlotte.net/blog/the-cool-of-the-evening'
}, {
  id: 6,
  name: 'Uncle',
  link: 'https://charlotte.net/blog/uncle'
}, {
  id: 7,
  name: 'Off to the fair',
  link: 'https://charlotte.net/blog/off-to-the-fair'
}, {
  id: 8,
  name: 'The crickets',
  link: 'https://charlotte.net/blog/the-crickets'
}, {
  id: 9,
  name: 'Dr. Dorian',
  link: 'https://charlotte.net/blog/dr-dorian'
}, {
  id: 10,
  name: 'Good progress',
  link: 'https://charlotte.net/blog/good-progress'
}, {
  id: 11,
  name: 'A meeting',
  link: 'https://charlotte.net/blog/a-meeting'
}, {
  id: 12,
  name: 'The miracle',
...
function RecentEntry(props) {
    return React.createElement(
        'a',
        { href: props.entryLink },
        props.entryName
    );
}
exports.default = RecentEntry;
